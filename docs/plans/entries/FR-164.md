- [x] FR-164 (proposed 2026-08-29; OWNER DECIDED 2026-08-30 -- "everything is
  ...
  **NEEDS AN OWNER DECISION.**
  ...
  PHASE 2 LANDED 2026-09-11 AS FR-245 (see that entry for the measured
  record): all 27 CMakeLists.txt and test/lit.site.cfg.py.in deleted,
  PDLL decided (showcase deleted, #ifdef seams kept, plain tblgen kept),
  pkgs.cmake kept for the TRACTOR corpus configure step, residual
  build/bin defaults verified already migrated. CLOSED.

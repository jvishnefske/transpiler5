...
// capture every source before any carried variable is assigned. FR-61d
// inlines the FIRST temporary into its assignment (nothing is written
// between its capture and its use), but the second temporary's `let` MUST
// survive: the first assignment overwrites its source, and an assignment
// is an inlining barrier -- this is the lost-copy protection itself.
